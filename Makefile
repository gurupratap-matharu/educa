APP_LIST ?= pages courses students users chat main
...
status:
	...
	@sudo systemctl status falcon-educa.socket

	@echo "Gunicorn Service"
	@sudo systemctl status falcon-educa.service
...
reload:
	...
	@sudo systemctl restart educa-gunicorn.socket

	@echo "🦄 restarting gunicorn service..."
	@sudo systemctl restart educa-gunicorn.service
...
logs:
	@sudo journalctl -fu educa-gunicorn.service
